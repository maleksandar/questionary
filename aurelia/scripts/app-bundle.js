define('app',['exports', './services/auth', 'aurelia-framework', 'aurelia-dialog', './dialogs/login', './dialogs/signup'], function (exports, _auth, _aureliaFramework, _aureliaDialog, _login, _signup) {
  ...
  var App = exports.App = (_dec = (0, _aureliaFramework.inject)(_auth.Auth, _aureliaDialog.DialogService), _dec2 = (0, _aureliaFramework.computedFrom)('auth.isLogedIn'), _dec3 = (0, _aureliaFramework.computedFrom)('auth.currentUser.role'), _dec(_class = (_class2 = function () {
    ...
    App.prototype.configureRouter = function configureRouter(config, router) {
      ...
      config.map([{ route: '', moduleId: 'pages/questions', title: 'Questions' }, { route: 'home', moduleId: 'pages/home', title: 'Home', nav: false }, { route: 'admin', moduleId: 'pages/admin', title: 'Admin', nav: false }, { route: 'about', moduleId: 'pages/about', title: 'About' }, { route: 'question/:id', moduleId: 'pages/question-details', name: 'question-details', title: 'Question' }]);
      this.router = router;
    };
    ...
    return App;
  }(), (_applyDecoratedDescriptor(_class2.prototype, 'authenticated', [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, 'authenticated'), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, 'isAdmin', [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, 'isAdmin'), _class2.prototype)), _class2)) || _class);
});
  ...
  var Signup = exports.Signup = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, _aureliaRouter.Router, _aureliaDialog.DialogController), _dec(_class = function () {
    ...
    Signup.prototype.signup = function signup() {
      ...
      this.httpClient.fetch('users', {
        ...
        return reason.json().then(function (reason) {
          console.log(reason);
          if (reason.name === "SequelizeUniqueConstraintError") {
            _this.signupError = '\'' + _this.email + '\' aready exists.';
          }
        });
      });
    };
...
define('pages/admin',['exports', '../services/auth', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-dialog', '../resources/elements/confirmation-dialog'], function (exports, _auth, _aureliaFramework, _aureliaFetchClient, _aureliaDialog, _confirmationDialog) {
  'use strict';
  ...
  var Admin = exports.Admin = (_dec = (0, _aureliaFramework.inject)(_auth.Auth, _aureliaFetchClient.HttpClient, _aureliaDialog.DialogService), _dec2 = (0, _aureliaFramework.computedFrom)('auth.currentUser.role'), _dec(_class = (_class2 = function () {
    function Admin(auth, httpClient, dialogService) {
    ...
    Admin.prototype.attached = function attached() {
      ...
      this.httpClient.fetch('users').then(function (response) {
        return response.json();
      }).then(function (users) {
        _this.users = users;
      });
    ...
    Admin.prototype.canActivate = function canActivate() {
      return this.auth.currentUser.role === 'admin';
    };

    Admin.prototype.addDomain = function addDomain() {
      var _this2 = this;

      this.httpClient.fetch('domains', { method: 'post', body: (0, _aureliaFetchClient.json)({ text: this.domain }) }).then(function () {
        _this2.httpClient.fetch('domains').then(function (response) {
          return response.json();
        }).then(function (domains) {
          _this2.domains = domains;_this2.domain = "";
        });
      });
    };

    Admin.prototype.deleteDomain = function deleteDomain(dom) {
      var _this3 = this;

      this.dialogService.open({ viewModel: _confirmationDialog.ConfirmationDialog, model: { headline: "Delete domain", message: "Are you sure you want to delete this domain?" } }).then(function (response) {
        if (!response.wasCancelled) {
          _this3.httpClient.fetch('domains/' + dom.text, { method: 'delete' }).then(function () {
            _this3.httpClient.fetch('domains').then(function (response) {
              return response.json();
            }).then(function (domains) {
              _this3.domains = domains;
            });
          });
        }
      });
    ...
    Admin.prototype.deleteUser = function deleteUser(u) {
      var _this4 = this;

      this.dialogService.open({ viewModel: _confirmationDialog.ConfirmationDialog, model: { headline: "Delete user", message: "Are you sure you want to delete this user?" } }).then(function (response) {
        if (!response.wasCancelled) {
          _this4.httpClient.fetch('users/' + u._id, { method: 'delete' }).then(function () {
            _this4.httpClient.fetch('users').then(function (response) {
              return response.json();
            }).then(function (users) {
              _this4.users = users;
            });
    ...
    return Admin;
  }(), (_applyDecoratedDescriptor(_class2.prototype, 'isAdmin', [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, 'isAdmin'), _class2.prototype)), _class2)) || _class);
});
define('pages/home',['exports', '../services/auth', 'aurelia-framework'], function (exports, _auth, _aureliaFramework) {
  ...
  var Home = exports.Home = (_dec = (0, _aureliaFramework.inject)(_auth.Auth), _dec(_class = function () {
    ...
    Home.prototype.showFilter = function showFilter() {
    ...
    Home.prototype.showForm = function showForm() {
...
define('pages/questions',['exports', '../services/auth', 'aurelia-framework'], function (exports, _auth, _aureliaFramework) {
  'use strict';
  ...
  var Questions = exports.Questions = (_dec = (0, _aureliaFramework.inject)(_auth.Auth), _dec2 = (0, _aureliaFramework.computedFrom)('auth.isLogedIn'), _dec(_class = (_class2 = function () {
    function Questions(auth) {
    ...
    Questions.prototype.showFilter = function showFilter() {
      if (this.sideForm === 'filter') {
        this.sideForm = null;
      } else {
        this.sideForm = 'filter';
    ...
    Questions.prototype.showForm = function showForm() {
      if (this.sideForm === 'form') {
        this.sideForm = null;
      } else {
        this.sideForm = 'form';
...
define('resources/index',['exports'], function (exports) {
                        ...
                        function configure(config) {
                                                config.globalResources(['./elements/question-list', './elements/question-form', './elements/question-filter', './elements/confirmation-dialog']);
                        }
});
  ...
  var Auth = exports.Auth = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, _aureliaRouter.Router), _dec(_class = function () {
    ...
    Auth.prototype.login = function login(email, password) {
      ...
      return this.httpClient.fetch('auth/login', {
        ...
        _this.currentUser.role = userinfo.user_role;
...
define('resources/elements/edit-dialog',['exports', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-dialog'], function (exports, _aureliaFramework, _aureliaFetchClient, _aureliaDialog) {
    'use strict';
    ...
    var EditDialog = exports.EditDialog = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, _aureliaDialog.DialogController), _dec(_class = function () {
        function EditDialog(httpClient, dialogController) {
            var _this = this;
        ...
        EditDialog.prototype.activate = function activate(content) {
            this.headline = content.headline;
        ...
        EditDialog.prototype.removeTag = function removeTag(tagText) {
        ...
        EditDialog.prototype.addTag = function addTag() {
            if (this.tag) {
...
define('resources/elements/question-filter',['exports', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-event-aggregator'], function (exports, _aureliaFramework, _aureliaFetchClient, _aureliaEventAggregator) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.QuestionFilter = undefined;
  ...
  var QuestionFilter = exports.QuestionFilter = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, _aureliaEventAggregator.EventAggregator), _dec(_class = function () {
    function QuestionFilter(httpClient, ea) {
      var _this = this;
    ...
    QuestionFilter.prototype.filter = function filter() {
    ...
    QuestionFilter.prototype.addTag = function addTag() {
      if (this.tag) {
    ...
    QuestionFilter.prototype.removeTag = function removeTag(tagText) {
...
define('resources/elements/question-form',['exports', 'aurelia-fetch-client', 'aurelia-framework', 'aurelia-event-aggregator', 'toastr'], function (exports, _aureliaFetchClient, _aureliaFramework, _aureliaEventAggregator, toastr) {
  'use strict';
  ...
  var QuestionForm = exports.QuestionForm = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, toastr, _aureliaEventAggregator.EventAggregator), _dec(_class = function () {
    function QuestionForm(httpClient, toastr, ea) {
      var _this = this;
    ...
    QuestionForm.prototype.postQuestion = function postQuestion() {
      ...
      return this.httpClient.fetch('questions', {
        ...
        _this2.tags = [];
        _this2.tag = "";
        _this2.ea.publish('questionAdded');
      }).catch(function () {
...
define('resources/elements/question-list',['exports', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-event-aggregator'], function (exports, _aureliaFramework, _aureliaFetchClient, _aureliaEventAggregator) {
  'use strict';
  ...
  var QuestionList = exports.QuestionList = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, _aureliaEventAggregator.EventAggregator), _dec(_class = (_class2 = function () {
    function QuestionList(httpClient, ea) {
    ...
    QuestionList.prototype.attached = function attached() {
      ...
      this.filterSubscriber = this.ea.subscribe('questionsFiltered', function (message) {
        _this.filter = message;
        _this.setRequestBase();

        if (message.domain) {
          _this.request += '&domainFilter=' + message.domain;
        }
        if (message.questionText) {
          _this.request += '&questiontextFilter=' + message.questionText;
        }
        if (message.tags.length) {
          message.tags.forEach(function (tag) {
            _this.request += '&tagFilter=' + tag;
          });
        }
        _this.getQuestions();
      });

      this.questionAddedSubscriber = this.ea.subscribe('questionAdded', function (message) {
        _this.getQuestions();
      });

      this.questionDeletedSubscriber = this.ea.subscribe('questionDeleted', function (mesage) {
        _this.getQuestions();
      });
    ...
    QuestionList.prototype.setRequestBase = function setRequestBase() {
      this.request = '';
    ...
    QuestionList.prototype.getQuestions = function getQuestions() {
      var _this2 = this;

      this.httpClient.fetch(this.request).then(function (response) {
        return response.json();
      }).then(function (responseObj) {
        if (responseObj.count != 0) {
          _this2.setParams(responseObj);
          _this2.currentIndex = 0;
        } else {
          _this2.questions = [];
          _this2.questionsIsNotEmpty = false;
          _this2.paginationGreater = false;
          _this2.paginationLower = false;
          _this2.currentIndex = 0;
        }
      });
    };
    ...
    QuestionList.prototype.setPage = function setPage(index) {
      ...
      this.httpClient.fetch(this.request + ('&offset=' + index * 3)).then(function (response) {
        return response.json();
      }).then(function (responseObj) {
        _this3.setParams(responseObj);
      });
      this.currentIndex = index;
    };

    QuestionList.prototype.getPages = function getPages(index) {
      if (index <= 1) return this.pageIndexes.slice(1, 4);else if (index > 1 && index <= this.pageIndexes.length - 3) return this.pageIndexes.slice(index - 1, index + 2);else if (index > 1 && index > this.pageIndexes.length - 3) return this.pageIndexes.slice(this.pageIndexes.length - 4, this.pageIndexes.length - 1);
    };

    QuestionList.prototype.setParams = function setParams(responseObj) {
      if (responseObj.count != 0) {
        console.log(responseObj);
        this.questions = responseObj.rows;
        this.questionsIsNotEmpty = true;
        var count = responseObj.count;
        if (count % 3 == 0) this.pageIndexes = Array.from(new Array(Math.floor(count / 3)), function (x, i) {
          return i;
        });else this.pageIndexes = Array.from(new Array(Math.floor(count / 3) + 1), function (x, i) {
          return i;
        });
    ...
    QuestionList.prototype.detached = function detached() {
...
define('resources/elements/question',['exports', 'aurelia-framework', 'aurelia-fetch-client', '../../services/auth', 'aurelia-dialog', './confirmation-dialog', './edit-dialog', 'aurelia-event-aggregator', 'toastr'], function (exports, _aureliaFramework, _aureliaFetchClient, _auth, _aureliaDialog, _confirmationDialog, _editDialog, _aureliaEventAggregator, toastr) {
  'use strict';
  ...
  var Question = exports.Question = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient, toastr, _auth.Auth, _aureliaDialog.DialogService, _aureliaEventAggregator.EventAggregator), _dec2 = (0, _aureliaFramework.computedFrom)('auth.currentUser.userId', 'content.createdByUserId'), _dec3 = (0, _aureliaFramework.computedFrom)('auth.isLogedIn'), _dec(_class = (_class2 = function () {
    ...
    Question.prototype.attached = function attached() {
      ...
      this.httpClient.fetch('users/' + this.content.createdByUserId).then(function (response) {
        return response.json();
      }).then(function (user) {
    ...
    Question.prototype.edit = function edit() {
      ...
      this.dialogService.open({ viewModel: _editDialog.EditDialog, model: {
          ...
          questionTags: this.content.TagQuestions.map(function (tag) {
            return tag.TagText;
          }),
        ...
        if (!dialogResponse.wasCancelled) {
          ...
          _this3.httpClient.fetch('questions/' + _this3.content._id, {
            ...
            if (resObj.updated) {
              _this3.toastr.success('You have successfully edited your question');
              _this3.content.headline = dialogResponse.output.headline;
              _this3.content.text = dialogResponse.output.text;
              _this3.content.TagQuestions = dialogResponse.output.tags.map(function (tag) {
                return { TagText: tag };
              });
              _this3.content.DomainText = dialogResponse.output.domain;
            }
          });
        }
      });
      ...
      this.dialogService.open({ viewModel: _confirmationDialog.ConfirmationDialog, model: { headline: "Delete question", message: "Are you sure you want to delete this question?" } }).then(function (response) {
        if (!response.wasCancelled) {
          ...
          _this4.httpClient.fetch('questions/' + _this4.content._id, { method: 'delete' }).then(function () {
            _this4.ea.publish('questionDeleted', { id: _this4.content._id });
...
define('text!app.html', ['module'], function(module) { module.exports = "<template>\r\n  <require from=\"bootstrap/css/bootstrap.css\"></require>\r\n  <require from=\"./styles.css\"></require>\r\n<nav class=\"navbar navbar-inverse navbar-fixed-top\">\r\n  <div class=\"container-fluid\">\r\n    <div class=\"navbar-header\">\r\n      <button type=\"button\" class=\"navbar-toggle\" data-toggle=\"collapse\" data-target=\"#myNavbar\">\r\n        <span class=\"icon-bar\"></span>\r\n        <span class=\"icon-bar\"></span>\r\n        <span class=\"icon-bar\"></span>                        \r\n      </button>\r\n      <a class=\"navbar-brand\" href=\"#\">Questionary</a>\r\n    </div>\r\n    <div class=\"collapse navbar-collapse\" id=\"myNavbar\">\r\n      <ul class=\"nav navbar-nav\">\r\n        <li><a if.bind=\"authenticated\" href=\"/#/home\"><span class=\"fa fa-home\"></span> Home</a></li>\r\n        <li><a href=\"/#/about\">About</a></li>\r\n        <li><a if.bind=\"isAdmin\" href=\"/#/admin\"><span class=\"fa fa-cogs\"></span> Admin</a></li>\r\n        \r\n      </ul>\r\n\r\n      <ul class=\"nav navbar-nav navbar-right\">\r\n        <li><a if.bind=\"!authenticated\" href=\"#\" click.trigger=\"signupModal()\"><span class=\"fa fa-user\"></span> Sign Up</a></li>\r\n        <li><a if.bind=\"!authenticated\" href=\"#\" click.trigger=\"loginModal()\"><span class=\"fa fa-sign-in\"></span> Login</a></li>\r\n        <li><a if.bind=\"authenticated\" href=\"#\" click.trigger=\"auth.logout()\"><span class=\"fa fa-sign-out\"></span> Logout</a></li>\r\n      </ul>\r\n    </div>\r\n  </div>\r\n</nav>\r\n      <div class='router-view'>\r\n        <router-view class=\"col-md-12 col-xs-12 col-sm-12 col-lg-12\"></router-view>\r\n      </div>\r\n  </div>\r\n</template>\r\n"; });
...
define('text!pages/questions.html', ['module'], function(module) { module.exports = "<template>\r\n  <div class=\"row\">\r\n    <div class =\"col-xs-12 col-sm-4 col-md-4 col-lg-4\">\r\n      <div class=\"row\">\r\n        <button if.bind=\"authenticated\" class=\" ${ sideForm === 'form'? 'active': ''} btn btn-default col-md-6 col-sm-6 col-xs-6 col-lg-6\" click.trigger=\"showForm()\">Ask a Question</button>\r\n        <button class=\"${ sideForm === 'filter'? 'active': ''} btn btn-default col-md-6 col-sm-6 col-xs-6 col-lg-6\" click.trigger=\"showFilter()\">FilterQuestions</button>\r\n      </div>\r\n      <question-filter if.bind=\"sideForm==='filter'\"></question-filter>\r\n      <question-form if.bind=\"sideForm==='form' && authenticated\"></question-form>\r\n    </div>\r\n    <div class =\"col-xs-12 col-sm-8 col-md-8 col-lg-8\">\r\n      <h4> Filtered Questions: </h4>\r\n      <question-list></question-list>\r\n    </div>\r\n  </div>\r\n</template>"; });
...
define('text!resources/elements/edit-dialog.html', ['module'], function(module) { module.exports = "<template>\r\n  <ai-dialog>\r\n    <ai-dialog-header>\r\n      <h4 class=\"modal-title\"> ${headline} </h4>\r\n    </ai-dialog-header>\r\n      <ai-dialog-body>\r\n        <div class=\"questionForm\" role=\"form\">\r\n            <div class=\"form-group\">\r\n                <label for=\"retObj.headline\">Headline:</label>\r\n                <input value.bind=\"retObj.headline\" required type=\"text\" class=\"form-control\" name=\"headline\" placeholder=\"Enter the headline of your question\">\r\n            </div>\r\n            <div class=\"form-group\">\r\n                <label for=\"retObj.text\">Text:</label>\r\n                <textarea value.bind=\"retObj.text\" class=\"form-control\" rows=\"7\" name=\"text\" placeholder=\"Enter the text of your question\"></textarea>\r\n            </div>\r\n         <div class=\"form-group\">\r\n            <div>\r\n                &nbsp;<span repeat.for=\"tag of retObj.tags\"> <span class=\"tag tag-pill\"> ${tag} <i click.trigger=\"removeTag(tag)\" class=\"fa fa-times\" aria-hidden=\"true\"></i></span>          </span>\r\n            </div>\r\n            <div class=\"input-group col-md-6\">\r\n                <input type=\"text\" class=\"form-control\" name=\"tag\" placeholder=\"Add tag:\" value.bind=\"tag\">\r\n                <div class=\"input-group-btn\">\r\n                    <button class=\"btn btn-primary\" click.trigger=\"addTag()\"> \r\n                        <i class=\"fa fa-plus\" aria-hidden=\"true\"></i>\r\n                        <i class=\"fa fa-tag\" aria-hidden=\"true\"></i>\r\n                    </button>\r\n                </div>\r\n            </div>\r\n         </div>\r\n         <div class=\"form-group\">\r\n            <div class=\"input-group col-md-12\">\r\n            <label for=\"doman\"> Domain: </label>\r\n            <select value.bind=\"retObj.domain\" name=\"domain\" class=\"form-control\" data-live-search=\"true\" style=\"height: 34px\">\r\n                <option repeat.for=\"domainOption of domains\" model.bind=\"domainOption\" selected=\"${retObj.domain === domainOption.text}\">${domainOption.text}</option>\r\n            </select>\r\n            </div>\r\n         </div>\r\n\r\n        </div>\r\n      </ai-dialog-body>\r\n      <ai-dialog-footer>\r\n         <button click.trigger = \"dialogController.cancel()\">Cancel</button>\r\n         <button click.trigger = \"dialogController.ok(retObj)\">Ok</button>\r\n      </ai-dialog-footer>\r\n  </ai-dialog>\r\n<"; });
