...
define('pages/logout',['exports', 'aurelia-framework', 'aurelia-router', '../services/auth', 'aurelia-dialog'], function (exports, _aureliaFramework, _aureliaRouter, _auth, _aureliaDialog) {
  'use strict';
  ...
  var Logout = exports.Logout = (_dec = (0, _aureliaFramework.inject)(_auth.Auth, _aureliaDialog.DialogController), _dec(_class = function () {
    function Logout(auth, dialogController) {
    ...
    Logout.prototype.logout = function logout() {
      ...
      this.auth.logout().then(function () {
        console.log('loging out', _this.dialogController);
        _this.dialogController.close();
...
define('pages/signup',['exports', 'aurelia-framework', 'aurelia-fetch-client', 'aurelia-router', 'aurelia-dialog'], function (exports, _aureliaFramework, _aureliaFetchClient, _aureliaRouter, _aureliaDialog) {
  'use strict';
...
define('resources/elements/question-list',['exports', 'aurelia-framework', 'aurelia-fetch-client'], function (exports, _aureliaFramework, _aureliaFetchClient) {
  ...
  var QuestionList = exports.QuestionList = (_dec = (0, _aureliaFramework.inject)(_aureliaFetchClient.HttpClient), _dec(_class = (_class2 = function () {
    function QuestionList(httpClient) {
      ...
      this.httpClient.fetch('questions?include=Answers&include=Tags').then(function (response) {
        return response.json();
...
define('text!pages/logout.html', ['module'], function(module) { module.exports = "<template>\r\n  <ai-dialog>\r\n    <ai-dialog-header>\r\n      <button type=\"button\" class=\"close\" click.trigger=\"dialogController.cancel()\">&times;</button>\r\n      <h4 class=\"modal-title\">Log out</h4>\r\n    </ai-dialog-header>\r\n    <ai-dialog-body>\r\n\r\n<p style=\"text-align: center\"> Are you sure you want to log out?</p>\r\n<button click.trigger=\"logout()\" class=\"col-xs-12 btn btn-default btn-lg\">              <i class=\"fa fa-sign-in\" aria-hidden=\"true\"></i>\r\n    <span>  Log out </span></button>\r\n</ai-dialog-body>\r\n</ai-dialog>\r\n</template>"; });
